...
from core.db.db_connection import db_connection, get_db_cursor, get_model
from core.ingestion.insert_pdf_chunks import insert_pdf
from core.utils.menu import MENU, is_back, safe_input, safe_int_input
    ...
    try:
        while True:
            ...
            # === E: Evaluate ===
                ...
                try:
                    from core.experiments.auto_eval import run_evaluation
            ...
            # === T: Thesis Compare ===
                ...
                from core.thesis_comparator import compare_algorithms
                while True:
