...
if os.path.exists(dotenv_path):
    ...
    print(f"app.py: Loaded environment from {dotenv_path}")
else:
    load_dotenv()
...
def load_model_on_startup():
    ...
    print("⚠️  PLEASE WAIT! The server will not accept connections until this is done.")
    print("="*50 + "\n")
    ...
    print("\n" + "="*50)
    if model:
        print("✅ Model loaded successfully! Server is now ready.")
        print("🌐 You can now open http://127.0.0.1:8000 in your browser.")
    else:
...
def reset_system_data():
    ...
    try:
        ...
        try:
            ...
            print(f"BM25 refresh skipped: {e}")
